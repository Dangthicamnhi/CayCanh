  ...
  var ProductManager = (function () {
    ...
    */
    ...
    var setProduct = function (id, name, summary, price, quantity, image) {
      ...
      if (!id || !name || !image || isNaN(price) || isNaN(quantity)) {
  ...
  var loadMyCartEvent = function (targetSelector) {
    ...
    if (!$("#" + idCartModal).length) {
      $('body').append(
        ...
        '<a type="button" href="checkout.php" class="btn btn-primary ' + classCheckoutCart + '">Checkout</a>'+
        // '<a class="btn btn-primary" onclick="window.location.href='checkout.php';">Check Out</a>'+
        '</div>' +
        '</div>' +
        '</div>' +
        '</div>'

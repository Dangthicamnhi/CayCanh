            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="CayminiChart.php"><i class="fa fa-bar-chart-o fa-fw"></i> Thống kê<span class="fa arrow"></span></a>
                            <ul class="nav nav-second-level">
                                ...
                                <?php foreach ($result as $value) : ?>
                                    <li>
                                        <a class="<?php echo $category == $value['id'] ? 'active' : '' ?>" href="thongke?category=<?php echo $value['id'] ?>"><?php echo $value['name'] ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                            <!-- /.nav-second-level -->
